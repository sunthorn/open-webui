			...
			<div class="">
				<div class="mb-3.5">
					...
					<div class="mb-2.5">
						...
						<!-- axi fork: community badge row removed, same as Settings/About.svelte.
						     The Documentation link above is kept — it still points at real
						     upstream docs that apply to this build. -->
					</div>
